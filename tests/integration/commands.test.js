...
describe("Command Integration Tests", () => {
    ...
    describe("Transaction Commands", () => {
        ...
        test("should award coins correctly", async () => {
            const initialBalance = await currencyManager.getBalance(
                "123456789"
            );
        ...
        test("should spend coins correctly", async () => {
            ...
            const success = await currencyManager.spendCoins(
                "123456789",
                50,
                "Test purchase"
            );
    ...
    describe("Admin Commands", () => {
        test("admin add coins should work", async () => {
            const result = await currencyManager.adminAddCoins(
                "123456789",
                200,
                "Admin test"
            );
        ...
        test("admin remove coins should work", async () => {
            ...
            const result = await currencyManager.adminRemoveCoins(
                "123456789",
                100,
                "Admin test"
            );
    ...
    describe("Boost System", () => {
        test("should activate daily boost", async () => {
            ...
            console.log(
                `[TEST DEBUG] Daily boost activation result: ${success}`
            );
            ...
            if (!success) {
                ...
                console.log(
                    `[TEST DEBUG] User state after failed activation:`,
                    userState
                );
            }
